...
namespace ASL.PathTracer
{
    ...
    //public abstract class MaterialShader : ShaderBase
    //{
    //    public abstract Color GetAlbedo();

    //    public abstract bool Scatter(Ray ray, RayCastHit hit, out Color color, out Ray scatterRay, out Ray scatterDirectionalRay);
